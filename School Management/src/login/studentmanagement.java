...
public class studentmanagement {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmSajibPal.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmSajibPal = new JFrame();
		frmSajibPal.getContentPane().setForeground(new Color(0, 0, 0));
		frmSajibPal.getContentPane().setBackground(new Color(47, 79, 79));
		frmSajibPal.setTitle("sajib pal");
		frmSajibPal.setIconImage(Toolkit.getDefaultToolkit().getImage("DUET Logo.jpg"));
		frmSajibPal.setBounds(200, 60, 900, 700);
		frmSajibPal.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmSajibPal.getContentPane().setLayout(null);
		...
		frmSajibPal.getContentPane().add(panel);
			...
			public void keyReleased(KeyEvent e) {
				...
				if(e.getKeyCode()==KeyEvent.VK_DOWN||e.getKeyCode()==KeyEvent.VK_UP){
					...
					try{
					  ...
					  String tabel_click=(table.getModel().getValueAt(row,0).toString());
		...
		frmSajibPal.getContentPane().add(panel_2);
		...
		frmSajibPal.getContentPane().add(btnAdd);
		...
		frmSajibPal.getContentPane().add(panel_5);
		...
		btnClear.setBounds(21, 147, 89, 23);
		panel_4.add(btnClear);
		
		JButton btnNewButton = new JButton("DELETE");
		btnNewButton.setBounds(21, 101, 89, 23);
		...
		btnNewButton_1.setBounds(21, 192, 89, 23);
		panel_4.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Mail");
		btnNewButton_2.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnNewButton_2.setBounds(21, 234, 89, 23);
		panel_4.add(btnNewButton_2);
		
		JButton btnUpdate = new JButton("UPDATE");
		btnUpdate.setBounds(21, 57, 89, 23);
		...
		frmSajibPal.getContentPane().add(lblSearceOption);
		...
		frmSajibPal.getContentPane().add(textField_5);
		...
		frmSajibPal.getContentPane().add(lblSearceBox);
		...
		frmSajibPal.getContentPane().add(comboBox);
		...
		frmSajibPal.getContentPane().add(desktopPane);
		...
		frmSajibPal.getContentPane().add(btnAddImage);
		...
		frmSajibPal.getContentPane().add(panel_6);
		...
		frmSajibPal.getContentPane().add(lblGender);
		...
		frmSajibPal.getContentPane().add(rdbtnNewRadioButton);
		...
		frmSajibPal.getContentPane().add(rdbtnNewRadioButton_1);
		
		JPanel panel_7 = new JPanel();
		panel_7.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		panel_7.setBackground(new Color(47, 79, 79));
		panel_7.setBounds(461, 246, 320, 60);
		frmSajibPal.getContentPane().add(panel_7);
		...
		frmSajibPal.getContentPane().add(panel_8);
		panel_8.setLayout(null);
		
		JButton btnTableImage = new JButton("Table Image");
		btnTableImage.setBounds(122, 27, 102, 23);
		...
		frmSajibPal.getContentPane().add(panel_9);
		...
		frmSajibPal.setJMenuBar(menuBar);
